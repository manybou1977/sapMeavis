...
class BackController extends AbstractController
{
    ...
    public function ajoutProduit(Request $request, EntityManagerInterface $manager): Response
    {
        ...
        // grace à la méthode handleRequest de notre objet de formulaire, il charge à présent l'objet Product de données receptionnées du formulaire présentent dans notre objet request (Request étant la classe de symfony qui récupère la majeure partie des données de superGlobale =>$_GET, $_POST ...)
    ...
    public function ajoutAvis(EntityManagerInterface $manager, Request $request, ProductRepository $productRepository, $id): Response
    {
        ...
        $this->addFlash('success', 'ajout avis');
